...
# Give unittest.mock.patch a valid import path even when the parent folder has
# hyphens and the test loader imports this file under a non-identifier name.
_MODULE_ALIAS = "day01_solution"
...
for _function in (
    ...
    _function.__module__ = _MODULE_ALIAS
